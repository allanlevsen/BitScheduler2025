...
namespace BitSchedulerCore.Migrations
{
    ...
    [Migration("20260623164138_AutoPendingModelSync")]
    partial class AutoPendingModelSync
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridCell", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridCellVertex", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridNeighbor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridSearchRing", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridCell", b =>
                {
                    b.HasOne("BitSchedulerCore.HexGridVersion", "HexGridVersion")
                        .WithMany("Cells")
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridCellVertex", b =>
                {
                    b.HasOne("BitSchedulerCore.HexGridCell", "HexGridCell")
                        .WithMany("Vertices")
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridNeighbor", b =>
                {
                    ...
                    b.HasOne("BitSchedulerCore.HexGridCell", "NeighborHexGridCell")
                        .WithMany("NeighborOf")
            ...
            modelBuilder.Entity("BitSchedulerCore.HexGridSearchRing", b =>
                {
                    ...
                    b.HasOne("BitSchedulerCore.HexGridCell", "NearbyHexGridCell")
